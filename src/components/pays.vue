    ...
    data() {
        return {
            ...
            tableData: [{
                    ...
                    introduce: "支付宝（中国）网络技术有限公司是国内领先的第三方支付平台，致力于提供“简单、安全、快速”的支付解决方案。",
                    judge: ""
                },
                {
                    name: "微信支付",
                    image: require('../assets/weixin.jpg'),
                    introduce: "微信支付是集成在微信客户端的支付功能，用户可以通过手机完成快速的支付流程。",
                    judge: ""
                },
                {
                    name: "银联支付",
                    image: require('../assets/yinlian.jpg'),
                    introduce: "中国银联是通过银联跨行交易清算系统实现商业银行系统间的互联互通和资源共享，保证银行卡跨行、跨地区和跨境使用。",
                    judge: ""
                }
            ]
        };
